...
def get_openrouter_key():
    """Read the cloud API key without ever putting it in source code."""
...
CLOUD_MODE = bool(OPENROUTER_API_KEY)
...
# =========================================================
# HYBRID AI BACKEND: OPENROUTER CLOUD + LOCAL OLLAMA FALLBACK
# =========================================================
