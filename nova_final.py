...
""".format(current_date=datetime.now().strftime("%d %B %Y"))
    ...
    if pdf_mode == "content" and resume_task:
        system_prompt += """
...
- Output only the final resume content.
The application will privately convert this content into a real PDF.
"""
        ...
        try:
            ...
            if pdf_mode == "content":
                model_options.update({
                    "num_predict": 5000 if resume_task else 2200,
                    "num_batch": 512,
                })
